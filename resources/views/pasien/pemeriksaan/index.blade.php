...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Riwayat Pemeriksaan</p>
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/riwayat-pemeriksaan/detail/{{ $v->id }}" class="btn btn-sm btn-info btn-edit"
