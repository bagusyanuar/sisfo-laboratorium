...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Daftar Dokter</p>
        ...
        <div class="w-100 p-2">
            <div class="text-right mb-2 pr-3">
                <a href="/dokter/tambah" class="btn btn-primary"><i class="fa fa-plus mr-1"></i><span
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/dokter/edit/{{ $v->user->id }}" class="btn btn-sm btn-warning btn-edit"
...
@section('js')
    ...
    <script type="text/javascript">
        function destroy(id) {
            AjaxPost('/dokter/delete', {id}, function () {
