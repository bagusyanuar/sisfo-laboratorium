...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Laporan Hasil Pemeriksaan</p>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = DataTableGenerator('#table-data', '/laporan-pemeriksaan-dokter/data', [
                ...
                {data: 'status'},
                {
                    data: null, render: function (data, type, row, meta) {
                        ...
                        return '<a target="_blank" href="/laporan-pemeriksaan-dokter/cetak/' + data['id'] + '" class="btn btn-sm btn-success btn-edit"\n' +
                            'data-id="' + data['id'] + '"><i class="fa fa-print"></i></a>';
                    }
                },
            ], [], function (d) {
                d.tgl1 = $('#tgl1').val();
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let tgl1 = $('#tgl1').val();
                let tgl2 = $('#tgl2').val();
                window.open('/laporan-pemeriksaan-dokter/cetak?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
            })
        });
    </script>
@endsection
